...
import co.edu.unicauca.asae.app_formats_a.infrastructure.output.persistence.mappers.AFormatMapper;
...
public class ManageAFormatGatewayImplAdapter implements ManageAFormatGatewayIntPort {
    ...
    private final AFormatMapper aFormatMapper;
    ...
    public AFormat save(AFormat aFormat) {
        ...
        return aFormatMapper.toModel(aFormatEntity);
    }
